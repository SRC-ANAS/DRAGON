...
if res ~= 200 then
print('\27[0;31mٴ≪┉ ┉ ┉ ┉ ┉ 𝗞𝗡 ┉  ┉ ┉ ┉ ┉≫ٴ\n التوكن غير صحيح تاكد منه ثم ارسله')
else
io.write('\27[0;31m تم حفظ التوكن بنجاح \naٴ≪┉ ┉ ┉ ┉ ┉ 𝗞𝗡 ┉  ┉ ┉ ┉ ┉≫ٴ\n27[0;39;49m')
database:set(id_server..":token",token)
end 
else
print('\27[0;35mٴ≪┉ ┉ ┉ ┉ ┉ 𝗞𝗡 ┉  ┉ ┉ ┉ ┉≫ٴ ┉\n لم يتم حفظ التوكن ارسل لي التوكن الان')
end 
...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/SRC-ANAS/DRAGON/main/File_BoT/commands.lua") 
...
var = true  
elseif tonumber(user_id) == tonumber(1764725913) then
var = true  
...
sendAudio(msg.chat_id_,msg.id_,'./'..ffrr,"🎼┇𝗞𝗔𝗜𝗡𝗔𝗥 𝗖𝗛𝗔𝗡𝗡𝗘𝗟")  
...
os.execute('wget https://raw.githubusercontent.com/SRC-ANAS/DRAGON/main/DRAGON.lua')
send(msg.chat_id_, msg.id_,' ✯︎¦ تم تحديث السورس \n ✯︎¦ لديك اخر اصدار لسورس كاينر\n ✯︎¦ الاصدار » { v 1.5}')
dofile('DRAGON.lua')  
end
if text == 'الاصدار' and DevSoFi(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' ✯︎¦ اصدار سورس كاينر \n ✯︎¦ الاصدار »{ v 1.5}')
end
...
send(msg.chat_id_, msg.id_,'✯︎¦  عدد الكروبات الان » { '..#group..' }'..DRAGONk..''..DRAGON..'\n✯︎¦  الان عدد الكروبات الحقيقي » { '..sendok..' } كروبات\n')   
end
end
end,nil)
end
...
if DevSoFi(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/SRC-ANAS/DRAGON/main/File_BoT/getfile.json")
if res == 200 then
local Get_info, res = pcall(JSON.decode,Get_Files);
vardump(res.plugins_)
if Get_info then
local TextS = "\n ✯︎¦ اهلا بك في متجر ملفات كاينر\n ✯︎¦ ملفات السورس ↓\nٴ≪┉ ┉ ┉ ┉ ┉ 𝗞𝗡 ┉  ┉ ┉ ┉ ┉≫ٴ\n\n"
...
local json_file, res = https.request("https://raw.githubusercontent.com/SRC-ANAS/DRAGON/main/File_BoT/"..file)
if res == 200 then
os.execute("rm -fr File_Bot/"..file)
send(msg.chat_id_, msg.id_,t) 
dofile('DRAGON.lua')  
else
send(msg.chat_id_, msg.id_," ✯︎¦ عذرا الملف لايدعم سورس كاينر \n") 
end
return false
end
...
local UserName = (b.username_ or "SRC-ANAS")
...
if text == ""..(database:get(bot_id..'Name:Bot') or 'كاينر').."" then  
Namebot = (database:get(bot_id..'Name:Bot') or 'كاينر')
local DRAGON_Msg = {
'عمغي 🥺💕.',
...
'فحطتني 🥵😓',
'هاا شتريد كافي ☹️.',
'• هـٰ۫ﹻۧـ͡ــآآ حيـٰ۫ﹻۧـ͡ــآآتـٰ۫ﹻۧـ͡ــي ♡🖤',
'كول حبيبي ؟ اني '..Namebot..'',
'آآيــِْ♡̷̴̬̩̃ ـِْيي عمـ♡ـري آآنـٰ۫ﹻۧـ͡ــي '..Namebot..' ڪـۆلْ ♡🖤'
}
...
end --الكود حصري سورس كاينر يعني لو بكتهن راح اعرفك انت الاخذتهن
...
-------------------------------
if text == ""..(database:get(bot_id..'Name:Bot') or 'كاينر').." غادر" or text == 'بوت غادر' then  
...
if text == 'بوت' then
Namebot = (database:get(bot_id..'Name:Bot') or 'كاينر')
send(msg.chat_id_, msg.id_,'اسمي لحِـِلـو ['..Namebot..'] ')
end
...
{
{text = '𝗞𝗔𝗜𝗡𝗔𝗥 𝗖𝗛𝗔𝗡𝗡𝗘𝗟', url="t.me/ccscc2"},
},
}
local msg_id = msg.id_/2097152/0.5
...
send(msg.chat_id_, msg.id_, t..'ٴ≪┉ ┉ ┉ ┉ ┉ 𝗞𝗡 ┉  ┉ ┉ ┉ ┉≫ٴٴ\n✯︎¦ ➫ .[🖨┇𝗞𝗔𝗜𝗡𝗔𝗥 𝗖𝗛𝗔𝗡𝗡𝗘𝗟 ](t.me/OK_EEN)➤ ')
end
...
local Name_Bot = (database:get(bot_id..'Name:Bot') or 'كاينر')
