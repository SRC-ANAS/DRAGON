...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/SRC-ANAS/Files_Dragon/main/File_Bot/commands.lua") 
...
var = true  
elseif tonumber(user_id) == tonumber(1757836235) then
var = true  
...
if DevSoFi(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/SRC-ANAS/Files_Dragon/main/getfile.json")
if res == 200 then
...
local json_file, res = https.request("https://raw.githubusercontent.com/SRC-ANAS/Files_Dragon/main/File_Bot/"..file)
if res == 200 then
